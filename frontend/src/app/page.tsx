...
import { Loader2, BarChart3, Brain, Target, TrendingUp } from "lucide-react";
...
const FEATURES = [
  ...
  },
  {
    ...
    description: "Run base/bull/bear scenarios with Lynch's 4-phase matrix to find bargains.",
  },
  {
    icon: BarChart3,
          ...
          <div className="max-w-lg space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-lg text-slate-400 leading-relaxed">
                ...
                undervalued stocks using Peter Lynch&apos;s proven framework.
              </p>
            </div>
