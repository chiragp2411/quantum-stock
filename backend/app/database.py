...
def ai_analytics_col() -> Collection:
    return get_db()["ai_analytics"]
...
def ensure_indexes() -> None:
    ...
    ai_analytics_col().create_index([("created_at", -1)])
    ai_analytics_col().create_index([("symbol", 1), ("created_at", -1)])
